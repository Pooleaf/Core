...
public class Panel {
    ...
    private void checkRange(int position) {
        int x = PositionCalculator.getX(position, width);
        int y = PositionCalculator.getY(position, width);
    ...
    public void set(int x, int y, Object item) {
        set(PositionCalculator.calculatePosition(x, y), item);
    }
    ...
    public Object get(int x, int y) {
        return get(PositionCalculator.calculatePosition(x, y));
    }
