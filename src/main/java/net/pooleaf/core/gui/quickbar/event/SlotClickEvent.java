package net.pooleaf.core.gui.quickbar.event;

import lombok.Data;
import net.pooleaf.core.event.bukkit.event.CancellableEvent;
import net.pooleaf.core.gui.quickbar.QuickBar;
import net.pooleaf.core.gui.quickbar.QuickBarManager;
import net.pooleaf.core.gui.quickbar.Slot;
import net.pooleaf.core.gui.quickbar.SlotClickAction;
